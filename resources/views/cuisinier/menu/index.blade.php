<x-agent.cuisinier.cuisinierMaster title="Liste des plats">
    ...
    @if (count($produits) == 0)
        <h6 class="text-center mt-5 border p-3">Aucun Plat</h6>
    @else
                            ...
                            <div class="swiper-wrapper">
                                @foreach ($produit->images as $image)
                                    @if (count($produit->images))
                                        <div class="swiper-slide"><img src="{{ asset('storage/' . $image->url) }}" />
                                        </div>
                                    @endif
                                @endforeach
                            </div>
                                ...
                                <form action="{{ route('cuisinier.modifierPlat', $produit->id) }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id='label' name="label" class="form-control"
                                            placeholder="Nom de Produit" value="{{ $produit->label }}">
                                    </div>
                                    <div class="mb-3">
